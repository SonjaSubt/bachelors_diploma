...
def train_on_dataset(name, filename):
    ...
    model = MLPRegressor(hidden_layer_sizes=(128, 64), max_iter=1000, activation="relu", solver="adam", random_state=14)
    ...
    joblib.dump(model, f"models/mlp/mlp_model_{name}.pkl")
    joblib.dump(scaler, f"models/mlp/mlp_scaler_{name}.pkl")
