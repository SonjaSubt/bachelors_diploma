...
os.makedirs("models/xgboosting", exist_ok=True)
...
def train_on_dataset(name, filename):
    ...
    joblib.dump(model, f"models/xgboosting/xgb_model_{name}.pkl")
    joblib.dump(scaler, f"models/xgboosting/xgb_scaler_{name}.pkl")
